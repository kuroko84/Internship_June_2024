    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassOfStudents", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClassOfStudentId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Students", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Students_ClassOfStudents_ClassOfStudentId",
                        column: x => x.ClassOfStudentId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Scores", x => new { x.StudentId, x.CourseId, x.SubjectId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_ClassOfStudentId",
                table: "Students",
                column: "ClassOfStudentId");
        }
